...
public class WrapperMethods {
	...
	public void assertionuse(WebDriver screenName,String Expected,String message,String ObjectxPath)
	{
		
		try {
			WebElement ele= screenName.findElement(By.xpath(ObjectxPath));
			String Actual1=ele.getText();
			

		Assert.assertEquals(message, Expected, Actual1);
			//Assert.assertEquals(Expected, Actual1, message);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			System.out.println("assert failde ");
		}
		//Assert.assertEquals(message, Expected, Actual);
	//	Extent_Reporting.Log_Pass(Element_Name+"validating",Element_Name+" validate");
	...
	public boolean click(WebDriver screenName,String ObjectxPath,String Element_Name) throws Exception
	{
		boolean flag=true;
		try
		{
			WebElement webButton = screenName.findElement(By.cssSelector(ObjectxPath));
			webButton.click();
			Extent_Reporting.Log_Pass(Element_Name+" Clicked",Element_Name+" Clicked");
		}
		 catch(Throwable t)
	...
	public List<WebElement> getTableData2(WebDriver driver , String xpath)
	{
		// Grab the table 
		WebElement table = driver.findElement(By.xpath(xpath)); 
